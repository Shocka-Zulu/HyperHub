#
# Vivado generated .tcl for creating the pcileech_hyperhub vivado project.
...
set _xil_proj_name_ "pcileech_hyperhub"
...
set orig_proj_dir "[file normalize "$origin_dir/pcileech_hyperhub"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/pcileech_hyperhub_top.sv"]\
]
...
set file "src/pcileech_hyperhub_top.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "pcileech_hyperhub_top" -objects $obj
...
set file "[file normalize ${origin_dir}/src/pcileech_hyperhub.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "src/pcileech_hyperhub.xdc"
